...
class Settings:
    ...
    def load(cls) -> "Settings":
        ...
        backend_base_url = os.getenv("BACKEND_BASE_URL") or os.getenv("BRIDGE_URL") or "http://34.27.75.170/api"
        return cls(
            ...
            manual_command_timeout_seconds=float(os.getenv("MANUAL_COMMAND_TIMEOUT_SECONDS", "0.9")),
